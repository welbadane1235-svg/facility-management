(function(){
  'use strict';
  const BUILD='V433 supervisor unified distribution';
  ...
  bind(); [200,800,1600,2800,4500].forEach(t=>setTimeout(bind,t));
  ...
  try{new MutationObserver(()=>{if($('supervisorAttendanceList')&&!$('supervisorAttendanceList').classList.contains('sup-uni-v433')) setTimeout(()=>renderSupervisorUnified(false),80);}).observe(document.body,{childList:true,subtree:true});}catch(_){}
