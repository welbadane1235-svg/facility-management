(function(){
  'use strict';
  const BUILD='V428 نفس كشف الحضور القديم - بدون تكرار';
  ...
  window.tasneefCoreAttendanceV428={refresh,save,activate};
  console.log('Tasneef core attendance V428 loaded');
})();
